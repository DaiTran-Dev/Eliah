    ...
    <div class="container wp-container">
        ...
        <div class="col-12 col-lg-6 text-left">
            <div class="content-home-about">
                ...
                {{-- <a href="javascript:void(0)" class="btn-cha">Appointment</a> --}}
            </div>
        </div>
    </div>
    </div>
    <div class="wp-ah position-relative">
        <div class="wp-container container">
            <div class="list-serive-home">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)"><span>01.</span>Body treatment</a></li>
                        <li><a href="javascript:void(0)"><span>02.</span>Professinal makeup</a></li>
                        <li><a href="javascript:void(0)"><span>03.</span>Maincure & pedicure</a></li>
                        <li><a href="javascript:void(0)"><span>04.</span>Hair cut & Coloring</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="thumbnail position-relative">
                        <div class="img-thum position-relative">
                            ...
                            <ul class="content-it align-items-center">
                                ...
                                <li data-toggle="tooltip" data-placement="top" title="Add To Heart" onclick="clickWhishlist({{$product->id}})"><span><i
                        ...
                        <div class="content-thum">
                            ...
                            <div class="title-ct">
                            <a href="{{route('product-detail',[$product->product->slug,$product->id])}}">{{$product->product->name}}</a>
                            </div>
